...
__global__ void global_multi_thread(u32* part_term_dev_divide, u32 loop) {
	...
	for (i = 0; i < 32; i++) {
		...
		cube[0] = (tid_24 & 0x1) | (((tid_24 >> 1) & 0x1) << 1) | (((tid_24 >> 2) & 0x1) << 2) | (((tid_24 >> 3) & 0x1) << 3) | (((tid_24 >> 4) & 0x1) << 4) | (((tid_24 >> 5) & 0x1) << 5) | (((tid_24 >> 6) & 0x1) << 6) | (((tid_24 >> 7) & 0x1) << 7) | (((tid_24 >> 8) & 0x1) << 8) | (((tid_24 >> 9) & 0x1) << 9) | (((tid_24 >> 10) & 0x1) << 10) | (((tid_24 >> 11) & 0x1) << 11) | (((tid_24 >> 12) & 0x1) << 12) | (((tid_24 >> 13) & 0x1) << 13) | (((tid_24 >> 14) & 0x1) << 14) | (((tid_24 >> 15) & 0x1) << 15) | (((tid_24 >> 16) & 0x1) << 16) | (((tid_24 >> 17) & 0x1) << 17) | (((tid_24 >> 18) & 0x1) << 18) | (((tid_24 >> 19) & 0x1) << 19) | (((tid_24 >> 20) & 0x1) << 20) | (((tid_24 >> 21) & 0x1) << 21) | (((tid_24 >> 22) & 0x1) << 23) | (((tid_24 >> 23) & 0x1) << 25) | (((offset_28 >> 0) & 0x1) << 26) | (((offset_28 >> 1) & 0x1) << 28) | (((offset_28 >> 2) & 0x1) << 29) | (((offset_28 >> 3) & 0x1) << 30) | (((offset_28 >> 4) & 0x1) << 31);
		cube[1] = (((offset_28 >> 5) & 0x1) << 0) | (((offset_28 >> 6) & 0x1) << 2) | (((offset_28 >> 7) & 0x1) << 4) | (((offset_28 >> 8) & 0x1) << 5) | (((offset_28 >> 9) & 0x1) << 9) | (((offset_28 >> 10) & 0x1) << 11) | (((offset_28 >> 11) & 0x1) << 12) | (((offset_28 >> 12) & 0x1) << 14) | (((offset_28 >> 13) & 0x1) << 17) | (((offset_28 >> 14) & 0x1) << 20) | (((offset_28 >> 15) & 0x1) << 21) | (((offset_28 >> 16) & 0x1) << 23) | (((offset_28 >> 17) & 0x1) << 24) | (((offset_28 >> 18) & 0x1) << 27) | (((offset_28 >> 19) & 0x1) << 29) | (((offset_28 >> 20) & 0x1) << 30);
		cube[2] = (((offset_28 >> 21) & 0x1) << 0) | (((offset_28 >> 22) & 0x1) << 2) | (((offset_28 >> 23) & 0x1) << 4) | (((offset_28 >> 24) & 0x1) << 8) | (((offset_28 >> 25) & 0x1) << 10) | (((offset_28 >> 26) & 0x1) << 12) | (((offset_28 >> 27) & 0x1) << 15);
...
__global__ void  getsum(u32* part_term_host_divide, u32 loop, u32* sum1_dev, u32 dim) {
	...
	for (A = dim * tid; A < dim * (tid + 1); A++) {
		...
		for (i = 0; i < 32; i++) {
			...
			offset_28 = ((A << 5) | i);
			tid_24 = loop;
			if ((((offset_28 >> 22) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 0);
			}
			if ( (((tid_24 >> 4) & 0x1) == 0) && (((tid_24 >> 7) & 0x1) == 0) && (((offset_28 >> 20) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 1);
			}
			if ( (((tid_24 >> 3) & 0x1) == 0) && (((tid_24 >> 13) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 2);
			}
			if ((((tid_24 >> 3) & 0x1) == 0) && (((offset_28 >> 0) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 3);
			}
			if ( (((tid_24 >> 3) & 0x1) == 0) && (((offset_28 >> 20) & 0x1) == 0) && (((offset_28 >> 22) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 4);
			}
			if ((((tid_24 >> 6) & 0x1) == 0) && (((offset_28 >> 2) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 5);
			}
			if ( (((offset_28 >> 15) & 0x1) == 0) && (((offset_28 >> 23) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 6);
			}
			if ( (((tid_24 >> 4) & 0x1) == 0) && (((tid_24 >> 20) & 0x1) == 0) && (((offset_28 >> 11) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 7);
			}
			if ( (((tid_24 >> 17) & 0x1) == 0) && (((offset_28 >> 15) & 0x1) == 0) && (((offset_28 >> 20) & 0x1) == 0) && (((offset_28 >> 23) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 8);
			}
			if ( (((tid_24 >> 1) & 0x1) == 0) && (((offset_28 >> 4) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 9);
			}
			if ( (((tid_24 >> 5) & 0x1) == 0) && (((offset_28 >> 20) & 0x1) == 0) && (((offset_28 >> 22) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 10);
			}
			if ( (((tid_24 >> 21) & 0x1) == 0) && (((offset_28 >> 2) & 0x1) == 0) && (((offset_28 >> 16) & 0x1) == 0) && (((offset_28 >> 23) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 11);
			}
			if ( (((tid_24 >> 14) & 0x1) == 0) && (((offset_28 >> 2) & 0x1) == 0) && (((offset_28 >> 8) & 0x1) == 0) && (((offset_28 >> 23) & 0x1) == 0)) {
				sum1_dev[tid] ^= ((((part_term_host_divide[A]) >> (i)) & 0X1) << 12);
			}
			if ( (((tid_24 >> 6) & 0x1) == 0) && (((tid_24 >> 21) & 0x1) == 0) && (((tid_24 >> 2) & 0x1) == 0)) {
